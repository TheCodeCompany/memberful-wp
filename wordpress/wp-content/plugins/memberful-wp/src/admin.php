...
function memberful_wp_global_marketing() {
  if ( isset( $_POST['save_global_marketing'] ) && memberful_wp_valid_nonce( 'memberful_options' ) ) {
    if ( isset( $_POST['memberful_use_global_marketing'] ) ) {
      ...
      update_option( 'memberful_paragraph_count', min( 10, max( 1, (int) filter_input( INPUT_POST, 'memberful_paragraph_count', FILTER_SANITIZE_NUMBER_INT ) ) ) );
  ...
  $paragraph_count = get_option( 'memberful_paragraph_count', 2 );
